...
#git_repo(){
#  echo "${txtylw}cloning git repo of Sofiane Hamlaoui ${txtrst}"
#  git clone https://github.com/SofianeHamlaoui/WD-Decrypte.git
#}

git_repo(){
  echo "${txtylw}cloning Git Repo ${txtrst}"
...
chk_bin_size(){
  echo "${txtred}The file size should be of 40 bytes${txtrst}"
  echo "${txtylw}The file size of password.bin is (in bytes) $(ls -l password.bin | awk '{print $5}') ${txtrst}"
}
